...
@section('body')
<form class="" action="{{ route('centers.store') }}" method="post">
    <div class="page-title">
        <h2>Ajouter Centre Sanitaire</h2>
    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control input-lg" value="{{ old('name') }}" placeholder="Nom du centre" required>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="quarter" class="form-control input-lg" value="{{ old('name') }}" placeholder="Quartier du centre">
                        </div>
                    </div>
                </div>
